                ...
                <div class="pull-right">
                    ...
                    @elseif($category == 'service')
                        <a href="{{url('/admin/item/create?category=service')}}">
                            <button type="button" onclick="" class="btn btn-success pull-right"><i class="fa fa-plus"></i> 添加服务</button>
                        </a>
...
//                        d.updated_at_to = $('input[name="updated_at_to"]').val();
                ...
                "columns": [
                    ...
                    },
                    {
                        ...
                        'orderable': false,
                        render: function(data, type, row, meta) {
                            if(data == 0) return '<small class="label btn-success">自定义内容</small>';
                            else if(data == 2) return '<small class="label btn-info">关于我们</small>';
                            else if(data == 9) return '<small class="label btn-warning">合作加盟</small>';
                            else if(data == 11) return '<small class="label bg-primary">服务</small>';
                            else if(data == 12) return '<small class="label bg-teal">案例</small>';
                            else if(data == 21) return '<small class="label bg-purple">资讯</small>';
                            else return '<small class="label bg-black">未知模块</small>';
                        }
                    },
                    {
                        'data': 'pivot_menus',
