...
class ItemRepository {
    ...
    public function view_edit()
    {
        ...
        {
            $menus = RootMenu::get();
            $mine = RootItem::with(['menu',])->find($decode_id);
            if($mine)
            {
                unset($mine->id);
                ...
                if($category == '2') $view_blade = 'admin.item.edit-about';
                elseif($category == '11') $view_blade = 'admin.item.edit-service';
                elseif($category == '12') $view_blade = 'admin.item.edit-case';
