...
@section('title')
    @if($operate == 'create') 添加资讯动态 @else 编辑资讯动态 @endif
@endsection
...
@section('breadcrumb')
    ...
    <li><a href="{{url('/admin/item/list?category=coverage')}}"><i class="fa "></i> 资讯动态列表</a></li>
    ...
    <div class="col-md-12">
        ...
        <div class="box box-info form-container">
            ...
            <div class="box-header with-border" style="margin:16px 0;">
                <h3 class="box-title">@if($operate == 'create') 添加资讯动态 @else 编辑资讯动态 @endif</h3>
