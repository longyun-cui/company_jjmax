                                ...
                                <div class="radio">
                                    <label>
                                        <input type="radio" name="category" value="9"
                                               @if($operate == 'edit' && $data->category == 9) checked="checked" @endif> 合作伙伴
                                    </label>
                                </div>
                            </button>
                                ...
                                <div class="radio">
                                    <label>
                                        <input type="radio" name="category" value="11"
                                               @if($operate == 'edit' && $data->category == 11) checked="checked" @endif> 服务
                                    </label>
                                </div>
                            </button>
                                ...
                                <div class="radio">
                                    <label>
                                        <input type="radio" name="category" value="12"
                                               @if($operate == 'edit' && $data->category == 12) checked="checked" @endif> 案例
                                    </label>
                                </div>
                            </button>
